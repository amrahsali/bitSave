...
- **Simple saving interface** – Save Bitcoin with just a few taps.
- **Bitcoin conversion flow** – See your balance in local currency (NGN, etc.) using real‑time exchange rates.
- **Analytics dashboard** – Track your savings growth over time.
- **Non‑custodial** – You control your private keys. We never have access to your funds.
...
- **Frontend:** Complete (saving interface, conversion flow, analytics dashboard)
- **Backend:** In progress (transaction handling, conversion API, secure storage)
